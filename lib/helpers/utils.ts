...
const superadminMenuArr = ['CITIES', 'INQUIRIES', 'PAYMENTS', 'EVENTS', 'EMPLOYEES', 'ROLES', 'ADMINS', 'SPORTS', 'SUPPORT', 'CUSTOMERS', 'HOMEPAGE', 'EVENT_REQUEST', 'FAQ', 'BLOGS', 'HAPPY_CUSTOMERS', 'FEEDBACK'];
