...
const superadminMenuArr = ['CITIES', 'INQUIRIES', 'PAYMENTS', 'EVENTS', 'EMPLOYEES', 'ROLES', 'ADMINS', 'SPORTS', 'SUPPORT', 'CUSTOMERS', 'HOMEPAGE', 'EVENT_REQUEST', 'FAQ', 'BLOGS', 'HAPPY_CUSTOMERS', 'FEEDBACK', 'PARTNER_REQUEST', 'PARTNERS', 'GROUND_REVIEW'];

const adminMenuArr = ['EMPLOYEES', 'ROLES', 'VENUES', 'GROUNDS', 'PARTNERS', 'PARTNER_REQUEST', 'EXPENSES', 'PROMO_CODES', 'GROUND_REVIEW']
